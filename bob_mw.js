function middleware(iob, currenttemp, glucose, profile, autosens, meal, reservoir, clock, pumphistory, preferences, basalProfile) {
    ...
    const minCRratio = profile.minCRratio;
    const maxCRratio = profile.maxCRratio;
    ...
    if (useDynamicCR == true) {
        ...
        logCRratio = " TDD-corrected CR is on, crRatio = " + crRatio.toPrecision(3) + ", Reference BG level: " + crSensRefBG + ", CR scale factor: " + crScaleFactor + ", TDD-corrected CR: " + cr.toPrecision(3) + " g/U";
        } else {
